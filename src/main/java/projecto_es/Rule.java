...
public class Rule {
	...
	//Este array é do formato ArrayList[(id),(code smell),(active),(condition1),(logicalOperator),(condition2),...]
	private ArrayList<String> list;
	
	
	//Assume-se que a string que entra nesta função +e do formato "id:codeSmell:active:Metrics:NumericOperator:threshold:LogicalOperator:Metrics:NumericOperator:threshold:LogicalOperator:..."
