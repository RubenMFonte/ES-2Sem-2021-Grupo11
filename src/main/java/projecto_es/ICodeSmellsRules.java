...
public class ICodeSmellsRules {
	...
	private void initialize() {
		...
		boolean isUniq;
		ArrayList<String> allCodeSmells = new ArrayList<>();
		...
		String[][] allRulesJT = new String[allRules.size()][2];
		for(int i = 0; i<allRules.size();i++) {
			allRulesJT[i][0] = allRules.get(i).getID();
			allRulesJT[i][1] = allRules.get(i).onlyConditions();
		}
